        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeGoals = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AwayGoals = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    HomeTeamWinBetRate = table.Column<int>(type: "int", nullable: false),
                    AwayTeamWinBetRate = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BeyMoney = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameBets", x => new { x.GameId, x.BetId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameBets_ResultPredictions_ResultPredictionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameBets_BetId",
                table: "GameBets",
                column: "BetId");

            migrationBuilder.CreateIndex(
                name: "IX_GameBets_ResultPredictionId",
                table: "GameBets",
